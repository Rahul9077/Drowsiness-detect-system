...
def eye_condition(eye_points, facial_landmarks):
    ...
    # here hypot function is used to calculate the hypotenuse of a right angle triangle
...
while True:
    ...
    for face in faces:
        ...
        left_eye_ratio = eye_condition(left_eye_landmarks, landmarks)
        right_eye_ratio = eye_condition(right_eye_landmarks, landmarks)
        ...
        if count > 10:
            ...
            cv2.putText(frame, "Sleepy", (x, y - 5), font, 0.5, (0, 0, 255))
